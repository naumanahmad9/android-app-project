...
import com.letshomeco.hpnotebook.letshome.APIService;
import com.letshomeco.hpnotebook.letshome.Notifications.Client;
import com.letshomeco.hpnotebook.letshome.Notifications.Data;
import com.letshomeco.hpnotebook.letshome.Notifications.MyResponse;
import com.letshomeco.hpnotebook.letshome.Notifications.Sender;
import com.letshomeco.hpnotebook.letshome.Notifications.Token;
import com.letshomeco.hpnotebook.letshome.R;
import com.letshomeco.hpnotebook.letshome.adapters.MessageAdapter;
import com.letshomeco.hpnotebook.letshome.modelClasses.Chat;
...
public class FinalBookingActivity extends AppCompatActivity {
    ...
    FirebaseUser fuser;
    DatabaseReference reference, listingIdRef, listingUserIdRef;
...
*/
        ...
        if (!listing_detail_title.isEmpty() && !numberofdays.isEmpty() && !arrivaldate.isEmpty()) {
            String bookMessage = getString(com.letshomeco.hpnotebook.letshome.R.string.bookMessageText1)
                    + " " + listing_detail_title + " " + getString(com.letshomeco.hpnotebook.letshome.R.string.bookMessageText2)
                    + " " + numberofdays + " " + getString(com.letshomeco.hpnotebook.letshome.R.string.bookMessageText3)
                    + " " + arrivaldate + ".";
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")) {
                    ...
                    Toast.makeText(FinalBookingActivity.this, "You can't send empty message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if (response.code() == 200) {
                                        if (response.body().success != 1) {
                                            // Toast.makeText(FinalBookingActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    messageAdapter = new MessageAdapter(FinalBookingActivity.this, mchat, imageurl);
